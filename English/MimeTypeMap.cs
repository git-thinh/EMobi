...
namespace System
{
    public static class MimeTypeMap
    {
        ...
        private static readonly ConcurrentDictionary<string, string> _mappings = BuildMappings();
        ...
        public static string GetMimeType(string extension)
        {
            ...
            return _mappings.TryGetValue(extension, out string mime) ? mime : DefaultMimeType;
        }
    }
}
